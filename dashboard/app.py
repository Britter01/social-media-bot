...
def _model_badges(post: dict) -> str:
    ...
    if has_media:
        if bg_source == "cache":
            # Background was previously generated by Higgsfield/Imagen and served from cache.
            cached_label = "Higgsfield ✓" if os.environ.get("HIGGSFIELD_API_KEY") else "Imagen 3 ✓"
            parts.append(_badge(cached_label, "#DBEAFE", "#1D4ED8"))
